...
ggplot(fitness_scores[variant_type %in% c("singles","doubles"),])+
    geom_density(aes(x=-FL_kinase_fitness_scaled,col=variant_type,fill=variant_type),alpha=0.25)+
    geom_vline(xintercept=-median(fitness_scores[WT==TRUE,]$FL_kinase_fitness_scaled))+
    geom_vline(xintercept=-median(fitness_scores[STOP==TRUE,]$FL_kinase_fitness_scaled,na.rm = TRUE),linetype="dashed")+
    coord_cartesian(xlim = c(-0.4,0.6))+
    xlab("toxicity")+
    theme_classic()
ggsave("output_files/Figure1b_FL_activity_fitness_distribution.pdf")
  
ggplot(fitness_scores[variant_type %in% c("singles","doubles"),])+
    geom_density(aes(x=FL_sandwich_fitness_scaled,col=variant_type,fill=variant_type),alpha=0.25)+
    geom_vline(xintercept=mean(fitness_scores[WT==TRUE,]$FL_sandwich_fitness_scaled))+
    geom_vline(xintercept=mean(fitness_scores[STOP==TRUE,]$FL_sandwich_fitness_scaled,na.rm = TRUE),linetype="dashed")+
    coord_cartesian(xlim = c(-0.5,0.25))+
    theme_classic()
ggsave("output_files/Figure1e_FL_sandwich_fitness_distribution.pdf")
...
ggsave("output_files/FigureS7c_correlation_with_wb_KD_abundance.pdf")
...
ggsave("output_files/Figure1f_correlation_with_wb_FL_sandwich.pdf")
...
ggplot(ahler_ptyrdata_fitness[!duplicated(Variant),],aes(x=log2(ptyr),y=-KD_kinase_fitness))+
  ...
  theme_classic()+
  theme(text = element_text(size=15))
ggsave("output_files/FigureS7b_correlation_with_wb_KD_kinase.pdf")
...
ggplot(ahler_ptyrdata_fitness[!duplicated(Variant),],aes(x=log2(ptyr),y=-FL_kinase_fitness))+
  ...
  theme_classic()+
  theme(text = element_text(size=15))
ggsave("output_files/Figure1c_correlation_with_wb_FL_kinase.pdf")
...
ggsave("output_files/FigureS7f_KD_3statemodel_abundance_weights.pdf")

plot_weights_heatmap(weights_kdkin_ab_activity,"activity")
ggsave("output_files/FigureS7e_KD_3statemodel_activity_weights.pdf")
...
ggsave("output_files/Figure1k_FL_3statemodel_sandwich_weights.pdf")

plot_weights_heatmap(weights_flkin_sand_activity,"activity")
ggsave("output_files/Figure1l_FL_3statemodel_activity_weights.pdf")
